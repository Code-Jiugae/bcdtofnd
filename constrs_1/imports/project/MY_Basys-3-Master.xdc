...
#set_property -dict { PACKAGE_PIN W15  IOSTANDARD LVCMOS33 } [get_ports { i_a[3]  }]; #IO_L21N_T3_DQS_A06_D22_14  ,Sch=SW4
#set_property -dict { PACKAGE_PIN V15  IOSTANDARD LVCMOS33 } [get_ports { i_b[0]  }]; #IO_L21P_T3_DQS_14          ,Sch=SW5
#set_property -dict { PACKAGE_PIN W14  IOSTANDARD LVCMOS33 } [get_ports { i_b[1]  }]; #IO_L22N_T3_A04_D20_14      ,Sch=SW6
#set_property -dict { PACKAGE_PIN W13  IOSTANDARD LVCMOS33 } [get_ports { i_b[2]  }]; #IO_L22P_T3_A05_D21_14      ,Sch=SW7
#set_property -dict { PACKAGE_PIN V2   IOSTANDARD LVCMOS33 } [get_ports { i_b[3]  }]; #IO_L5P_T0_34               ,Sch=SW8
